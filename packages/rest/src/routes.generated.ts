...
export const ApplicationCommand = group({
   ...
   *
   * The objects returned by this endpoint may be augmented with [additional fields if localization
   * is
   * active](https://discordapp.com/developers/docs/interactions/application-commands#retrieving-localized-commands).
   *
   * Fetch all of the global commands for your application. Returns an array of [application
   * command](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-object) objects.
   */
   ...
   *
   * Create a new global command. Returns `201` and an [application
   * command](https://discordapp.com/developers/docs/interactions/application-commands#application-command-object)
   * object.
   */
  ...
  getGlobalApplicationCommand: {
    method: 'GET',
    route: (applicationId: string, commandId: string) =>
   ...
   *
   * Edit a global command. Returns `200` and an [application
   * command](https://discordapp.com/developers/docs/interactions/application-commands#application-command-object)
   * object. All fields are optional, but any fields provided will entirely overwrite the existing
   ...
   * application. Returns `200` and a list of [application
   * command](https://discordapp.com/developers/docs/interactions/application-commands#application-command-object)
   ...
   * [application command](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-object) objects.
   */
  getGuildApplicationCommands: {
    method: 'GET',
    route: (applicationId: string, guildId: string) =>
   ...
   * Returns `201` and an [application
   * command](https://discordapp.com/developers/docs/interactions/application-commands#application-command-object)
   * object. If the command did not already exist, it will count toward daily application command
   * create limits.
   */
  ...
  getGuildApplicationCommand: {
    method: 'GET',
    route: (applicationId: string, guildId: string, commandId: string) =>
   ...
   * application for the targeted guild. Returns `200` and a list of [application
   * command](https://discordapp.com/developers/docs/interactions/application-commands#application-command-object)
   * objects.
   *
   * This will overwrite **all** types of application commands: slash commands, user commands, and
   ...
   *
   * Fetches permissions for all commands for your application in a guild. Returns an array of
   * [guild application command
   * permissions](https://discordapp.com/developers/docs/interactions/application-commands#application-command-permissions-object-guild-application-command-permissions-structure)
   * objects.
   */
   ...
   *
   * Edits command permissions for a specific command for your application in a guild and returns a
   * [guild application command
   * permissions](https://discordapp.com/developers/docs/interactions/application-commands#application-command-permissions-object-guild-application-command-permissions-structure)
   * object.
   *
   ...
   *
   * This endpoint requires authentication with a Bearer token that has permission to manage the
   * guild and its roles. For more information, read above about [application command
   * permissions](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/permissions).
   *
   ...
   *
   * This endpoint has been disabled with [updates to command permissions (Permissions
   * v2)](https://discordapp.com/developers/docs/change/log#updated-command-permissions). Instead,
   * you can [edit each application command
   * permissions](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/edit-application-command-permissions)
   * (though you should be careful to handle any potential [rate limits](#DOCS_TOPICS_RATE_LIMITS)).
   */
...
export const AuditLog = group({
   ...
   *
   * Returns an [audit
   * log](https://discordapp.com/developers/docs/resources/audit-log#audit-log-object) object for
   * the guild. Requires the
   * [`VIEW_AUDIT_LOG`](#DOCS_TOPICS_PERMISSIONS/permissions-bitwise-permission-flags) permission.
   */
  getGuildAuditLog: {
    method: 'GET',
...
export const AutoModeration = group({
   ...
   *
   * Get a list of all rules currently configured for the guild. Returns a list of [auto moderation
   * rule](https://discordapp.com/developers/docs/resources/auto-moderation#auto-moderation-rule-object)
   * objects for the given guild.
   *
   * This endpoint requires the `MANAGE_GUILD`
   * [permission](#DOCS_RESOURCES_AUTO_MODERATION/auto-moderation-permission-requirements).
   */
   ...
   *
   * Get a single rule. Returns an [auto moderation
   * rule](https://discordapp.com/developers/docs/resources/auto-moderation#auto-moderation-rule-object)
   * object.
   *
   * This endpoint requires the `MANAGE_GUILD`
  ...
  getAutoModerationRule: {
    method: 'GET',
    route: (guildId: string, autoModerationRuleId: string) =>
   ...
   * [permissions](#DOCS_RESOURCES_AUTO_MODERATION/auto-moderation-permission-requirements).
   *
   * All parameters for this endpoint are optional.
   */
   ...
   *
   * This endpoint requires the `MANAGE_GUILD`
   * [permission](https://discordapp.com/developers/docs/resources/auto-moderation#auto-moderation-permission-requirements).
   */
...
export const Channel = group({
   ...
   *
   * Get a channel by ID. Returns a
   * [channel](https://discordapp.com/developers/docs/resources/channel#channel-object) object. If
   * the channel is a thread, a [thread member](#DOCS_RESOURCES_CHANNEL/thread-member-object) object
   ...
   * [channel](https://discordapp.com/developers/docs/resources/channel#channel-object) on success,
   * and a 400 BAD REQUEST on invalid parameters. All JSON parameters are optional.
   */
  modifyChannel: {
    method: 'PATCH',
    route: (channelId: string) => `/channels/${channelId}`,
   ...
   * child channels; they will have their `parent_id` removed and a [Channel
   * Update](https://discordapp.com/developers/docs/topics/gateway#channel-update) Gateway event
   * will fire for each of them. Returns a [channel](#DOCS_RESOURCES_CHANNEL/channel-object) object
   * on success. Fires a [Channel Delete](#DOCS_TOPICS_GATEWAY/channel-delete) Gateway event (or
   * [Thread Delete](#DOCS_TOPICS_GATEWAY/thread-delete) if the channel was a thread).
   *
   * Deleting a guild channel cannot be undone. Use this with caution, as it is impossible to undo
   * this action when performed on a guild channel. In contrast, when used with a private message,
   * it is possible to undo the action by opening a private message with the recipient again.
   *
   ...
   * cannot read the message history). Returns an array of
   * [message](https://discordapp.com/developers/docs/resources/channel#message-object) objects on success.
   *
   ...
   * [message](https://discordapp.com/developers/docs/resources/channel#message-object) object on success.
   */
  getChannelMessage: {
    method: 'GET',
   ...
   *
   * Discord may strip certain characters from message content, like invalid unicode characters or
   * characters which cause unexpected message formatting. If you are passing user-generated strings
   * into message content, consider sanitizing the data to prevent unexpected behavior and utilizing
   * `allowed_mentions` to prevent unexpected mentions.
   *
   * Post a message to a guild text or DM channel. Returns a
   * [message](https://discordapp.com/developers/docs/resources/channel#message-object) object.
   * Fires a [Message Create](#DOCS_TOPICS_GATEWAY/message-create) Gateway event. See [message
   * formatting](#DOCS_REFERENCE/message-formatting) for more information on how to properly format messages.
   *
   * To create a message as a reply to another message, apps can include a
   * [`message_reference`](#DOCS_RESOURCES_CHANNEL/message-reference-object-message-reference-structure)
   * with a `message_id`. The `channel_id` and `guild_id` in the `message_reference` are optional,
   * but will be validated if provided.
   *
   * Files must be attached using a `multipart/form-data` body as described in [Uploading
   * Files](#DOCS_REFERENCE/uploading-files).
   */
  createMessage: {
    method: 'POST',
    route: (channelId: string) => `/channels/${channelId}/messages`,
  ...
  crosspostMessage: {
    method: 'POST',
    route: (channelId: string, messageId: string) =>
   ...
   * to be present on the current user. Additionally, if nobody else has reacted to the message
   * using this emoji, this endpoint requires the `ADD_REACTIONS` permission to be present on the
   * current user. Returns a 204 empty response on success. The `emoji` must be [URL
   * Encoded](https://en.wikipedia.org/wiki/Percent-encoding) or the request will fail with `10014:
   * Unknown Emoji`. To use custom emoji, you must encode it in the format `name:id` with the emoji
   * name and emoji id.
   */
  createReaction: {
    method: 'PUT',
    route: (channelId: string, messageId: string, emoji: string) =>
   ...
   * success. The `emoji` must be [URL Encoded](https://en.wikipedia.org/wiki/Percent-encoding) or
   * the request will fail with `10014: Unknown Emoji`. To use custom emoji, you must encode it in
  ...
  deleteUserReaction: {
    method: 'DELETE',
    route: (channelId: string, messageId: string, emoji: string, userId: string) =>
   ...
   * [user](https://discordapp.com/developers/docs/resources/user#user-object) objects on success.
   * The `emoji` must be [URL Encoded](https://en.wikipedia.org/wiki/Percent-encoding) or the
   * request will fail with `10014: Unknown Emoji`. To use custom emoji, you must encode it in the
   ...
   * be present on the current user. Fires a [Message Reaction Remove
   * All](https://discordapp.com/developers/docs/topics/gateway#message-reaction-remove-all) Gateway event.
   */
  deleteAllReactions: {
    method: 'DELETE',
    route: (channelId: string, messageId: string) =>
   ...
   * Remove
   * Emoji](https://discordapp.com/developers/docs/topics/gateway#message-reaction-remove-emoji)
   * Gateway event. The `emoji` must be [URL
   * Encoded](https://en.wikipedia.org/wiki/Percent-encoding) or the request will fail with `10014:
   * Unknown Emoji`. To use custom emoji, you must encode it in the format `name:id` with the emoji
   * name and emoji id.
   */
   ...
   *
   * Edit a previously sent message. The fields `content`, `embeds`, and `flags` can be edited by
   ...
   * request, the content will be parsed with _default_ allowances, that is, without regard to
   * whether or not an `allowed_mentions` was present in the request that originally created the message.
   *
   * Returns a [message](https://discordapp.com/developers/docs/resources/channel#message-object)
   * object. Fires a [Message Update](#DOCS_TOPICS_GATEWAY/message-update) Gateway event.
   *
   * Refer to [Uploading Files](#DOCS_REFERENCE/uploading-files) for details on attachments and
   * `multipart/form-data` requests. Any provided files will be **appended** to the message. To
   * remove or replace files you will have to supply the `attachments` field which specifies the
   * files to retain on the message after edit.
   *
   * Starting with API v10, the `attachments` array must contain all attachments that should be
   * present after edit, including **retained and new** attachments provided in the request body.
   *
   ...
   * sent by the current user, this endpoint requires the `MANAGE_MESSAGES` permission. Returns a
   * 204 empty response on success. Fires a [Message
   * Delete](https://discordapp.com/developers/docs/topics/gateway#message-delete) Gateway event.
   */
  deleteMessage: {
    method: 'DELETE',
    route: (channelId: string, messageId: string) => `/channels/${channelId}/messages/${messageId}`,
   ...
   * [Message Delete
   * Bulk](https://discordapp.com/developers/docs/topics/gateway#message-delete-bulk) Gateway event.
   *
   ...
   * parent channel (if applicable) can be allowed/denied (unless your bot has a `MANAGE_ROLES`
   * overwrite in the channel). Returns a 204 empty response on success. For more information about
   * permissions, see [permissions](https://discordapp.com/developers/docs/topics/permissions#permissions).
   */
  editChannelPermissions: {
    method: 'PUT',
    route: (channelId: string, overwriteId: string) =>
   ...
   *
   * Returns a list of
   * [invite](https://discordapp.com/developers/docs/resources/invite#invite-object) objects (with
   * [invite metadata](#DOCS_RESOURCES_INVITE/invite-metadata-object)) for the channel. Only usable
   ...
   *
   * Create a new [invite](https://discordapp.com/developers/docs/resources/invite#invite-object)
   * object for the channel. Only usable for guild channels. Requires the `CREATE_INSTANT_INVITE`
   * permission. All JSON parameters for this route are optional, however the request body is not.
   * If you are not sending any fields, you still have to send an empty JSON object (`{}`). Returns
   * an [invite](#DOCS_RESOURCES_INVITE/invite-object) object. Fires an [Invite
   * Create](#DOCS_TOPICS_GATEWAY/invite-create) Gateway event.
   */
  createChannelInvite: {
    method: 'POST',
    route: (channelId: string) => `/channels/${channelId}/invites`,
   ...
   * permission in the target channel. Returns a [followed
   * channel](https://discordapp.com/developers/docs/resources/channel#followed-channel-object) object.
   */
  followNewsChannel: {
    method: 'POST',
   ...
   * message. Returns a 204 empty response on success. Fires a [Typing
   * Start](https://discordapp.com/developers/docs/topics/gateway#typing-start) Gateway event.
   */
   ...
   * [message](https://discordapp.com/developers/docs/resources/channel#message-object) objects.
   */
  getPinnedMessages: {
    method: 'GET',
   ...
   * [channel](https://discordapp.com/developers/docs/resources/channel#channel-object) on success,
   * and a 400 BAD REQUEST on invalid parameters. Fires a [Thread
   ...
   * `GUILD_NEWS` channel, creates a `GUILD_NEWS_THREAD`. Does not work on a
   * [`GUILD_FORUM`](#DOCS_RESOURCES_CHANNEL/start-thread-in-forum-channel) channel. The id of the
   * created thread will be the same as the id of the source message, and as such a message can only
   * have a single thread created from it.
   */
   ...
   * features](#DOCS_RESOURCES_GUILD/guild-object-guild-features) will indicate if that is possible
   * for the guild.
   */
   ...
   *
   * Creates a new thread in a forum channel, and sends a message within the created thread. Returns
   * a [channel](https://discordapp.com/developers/docs/resources/channel#channel-object), with a
   * nested [message](#DOCS_RESOURCES_CHANNEL/message-object) object, on success, and a 400 BAD
   * REQUEST on invalid parameters. Fires a [Thread Create](#DOCS_TOPICS_GATEWAY/thread-create) and
   * [Message Create](#DOCS_TOPICS_GATEWAY/message-create) Gateway event.
   *
   * - The type of the created thread is `GUILD_PUBLIC_THREAD`.
   * - See [message formatting](#DOCS_REFERENCE/message-formatting) for more information on how to
   *   properly format messages.
   * - The current user must have the `SEND_MESSAGES` permission (`CREATE_PUBLIC_THREADS` is ignored).
   * - The maximum request size when sending a message is **8MiB**.
   * - For the embed object, you can set every field except `type` (it will be `rich` regardless of if
   ...
   *
   * Adds the current user to a thread. Also requires the thread is not archived. Returns a 204
   * empty response on success. Fires a [Thread Members
   * Update](https://discordapp.com/developers/docs/topics/gateway#thread-members-update) Gateway event.
   */
  joinThread: {
    method: 'PUT',
   ...
   * requires the thread is not archived. Returns a 204 empty response if the member is successfully
   * added or was already a member of the thread. Fires a [Thread Members
   * Update](https://discordapp.com/developers/docs/topics/gateway#thread-members-update) Gateway event.
   */
  addThreadMember: {
    method: 'PUT',
   ...
   *
   * Removes another member from a thread. Requires the `MANAGE_THREADS` permission, or the creator
   ...
   *
   * Returns a [thread
   * member](https://discordapp.com/developers/docs/resources/channel#thread-member-object) object
   ...
   *
   * Returns array of [thread
   * members](https://discordapp.com/developers/docs/resources/channel#thread-member-object) objects
   * that are members of the thread.
   *
   * This endpoint is restricted according to whether the `GUILD_MEMBERS` [Privileged
   * Intent](#DOCS_TOPICS_GATEWAY/privileged-intents) is enabled for your application.
   */
  listThreadMembers: {
    method: 'GET',
   ...
   * returns threads of
   * [type](https://discordapp.com/developers/docs/resources/channel#channel-object-channel-types)
   * `GUILD_PUBLIC_THREAD`. When called on a `GUILD_NEWS` channel returns threads of
   * [type](#DOCS_RESOURCES_CHANNEL/channel-object-channel-types) `GUILD_NEWS_THREAD`. Threads are
   * ordered by `archive_timestamp`, in descending order. Requires the `READ_MESSAGE_HISTORY` permission.
   */
   ...
   * [type](https://discordapp.com/developers/docs/resources/channel#channel-object-channel-types)
   * `GUILD_PRIVATE_THREAD`. Threads are ordered by `archive_timestamp`, in descending order.
   ...
   * Returns archived threads in the channel that are of
   * [type](https://discordapp.com/developers/docs/resources/channel#channel-object-channel-types)
   * `GUILD_PRIVATE_THREAD`, and the user has joined. Threads are ordered by their `id`, in
...
export const Emoji = group({
   ...
   *
   * Returns a list of [emoji](https://discordapp.com/developers/docs/resources/emoji#emoji-object)
   * objects for the given guild.
   */
  listGuildEmojis: {
    method: 'GET',
   ...
   *
   * Returns an [emoji](https://discordapp.com/developers/docs/resources/emoji#emoji-object) object
   * for the given guild and emoji IDs.
   */
  getGuildEmoji: {
    method: 'GET',
   ...
   * the new [emoji](https://discordapp.com/developers/docs/resources/emoji#emoji-object) object on
   * success. Fires a [Guild Emojis Update](#DOCS_TOPICS_GATEWAY/guild-emojis-update) Gateway event.
   *
   ...
   * [JSON status code](#DOCS_TOPICS_OPCODES_AND_STATUS_CODES/json).
   */
  createGuildEmoji: {
    method: 'POST',
    route: (guildId: string) => `/guilds/${guildId}/emojis`,
   ...
   *
   * Modify the given emoji. Requires the `MANAGE_EMOJIS_AND_STICKERS` permission. Returns the
   * updated [emoji](https://discordapp.com/developers/docs/resources/emoji#emoji-object) object on
   * success. Fires a [Guild Emojis Update](#DOCS_TOPICS_GATEWAY/guild-emojis-update) Gateway event.
   *
   ...
   * Update](https://discordapp.com/developers/docs/topics/gateway#guild-emojis-update) Gateway event.
   */
  deleteGuildEmoji: {
    method: 'DELETE',
    route: (guildId: string, emojiId: string) => `/guilds/${guildId}/emojis/${emojiId}`,
...
export const Gateway = group({
   ...
   * [Connecting](https://discordapp.com/developers/docs/topics/gateway#connecting). Clients
   * **should** cache this value and only call this endpoint to retrieve a new URL if they are
   * unable to properly establish a connection using the cached version of the URL.
   */
  getGateway: {
    method: 'GET',
    route: '/gateway',
   ...
   * Gateway](https://discordapp.com/developers/docs/topics/gateway#get-gateway), plus additional
   * metadata that can help during the operation of large or
   * [sharded](#DOCS_TOPICS_GATEWAY/sharding) bots. Unlike the [Get
   * Gateway](#DOCS_TOPICS_GATEWAY/get-gateway), this route should not be cached for extended
   * periods of time as the value is not guaranteed to be the same per-call, and changes as the bot
   * joins/leaves guilds.
   */
  getGatewayBot: {
    method: 'GET',
...
export const Guild = group({
   ...
   *
   * Create a new guild. Returns a
   * [guild](https://discordapp.com/developers/docs/resources/guild#guild-object) object on success.
   * Fires a [Guild Create](#DOCS_TOPICS_GATEWAY/guild-create) Gateway event.
   *
   ...
   *
   * Returns the [guild](https://discordapp.com/developers/docs/resources/guild#guild-object) object
   * for the given id. If `with_counts` is set to `true`, this endpoint will also return
   ...
   *
   * Returns the [guild
   * preview](https://discordapp.com/developers/docs/resources/guild#guild-preview-object) object
   * for the given id. If the user is not in the guild, then the guild must be lurkable.
   */
  getGuildPreview: {
    method: 'GET',
   ...
   * [guild](https://discordapp.com/developers/docs/resources/guild#guild-object) object on success.
   * Fires a [Guild Update](#DOCS_TOPICS_GATEWAY/guild-update) Gateway event.
   *
   * All parameters to this endpoint are optional.
   *
   * Attempting to add or remove the `COMMUNITY` [guild
   * feature](#DOCS_RESOURCES_GUILD/guild-object-guild-features) requires the `ADMINISTRATOR` permission.
   */
  modifyGuild: {
    method: 'PATCH',
    route: (guildId: string) => `/guilds/${guildId}`,
   ...
   *
   * Delete a guild permanently. User must be owner. Returns `204 No Content` on success. Fires a
   * [Guild Delete](https://discordapp.com/developers/docs/topics/gateway#guild-delete) Gateway event.
   */
  deleteGuild: {
    method: 'DELETE',
    route: (guildId: string) => `/guilds/${guildId}`,
   ...
   *
   * Returns a list of guild
   * [channel](https://discordapp.com/developers/docs/resources/channel#channel-object) objects.
   ...
   *
   * Create a new [channel](https://discordapp.com/developers/docs/resources/channel#channel-object)
   * object for the guild. Requires the `MANAGE_CHANNELS` permission. If setting permission
   * overwrites, only permissions your bot has in the guild can be allowed/denied. Setting
   * `MANAGE_ROLES` permission in channels is only possible for guild administrators. Returns the
   * new [channel](#DOCS_RESOURCES_CHANNEL/channel-object) object on success. Fires a [Channel
   * Create](#DOCS_TOPICS_GATEWAY/channel-create) Gateway event.
   *
   ...
   * [channel](https://discordapp.com/developers/docs/resources/channel#channel-object) objects for
   * the guild. Requires `MANAGE_CHANNELS` permission. Returns a 204 empty response on success.
   * Fires multiple [Channel Update](#DOCS_TOPICS_GATEWAY/channel-update) Gateway events.
   *
   ...
   *
   * Returns a [guild
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object) object for
   * the specified user.
   */
  getGuildMember: {
    method: 'GET',
   ...
   *
   * Returns a list of [guild
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object) objects
   * that are members of the guild.
   *
   * This endpoint is restricted according to whether the `GUILD_MEMBERS` [Privileged
   * Intent](#DOCS_TOPICS_GATEWAY/privileged-intents) is enabled for your application.
   *
   ...
   * Returns a list of [guild
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object) objects
   * whose username or nickname starts with a provided string.
   *
   ...
   * `guilds.join` scope. Returns a 201 Created with the [guild
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object) as the
   * body, or 204 No Content if the user is already a member of the guild. Fires a [Guild Member
   * Add](#DOCS_TOPICS_GATEWAY/guild-member-add) Gateway event.
   *
   * For guilds with [Membership Screening](#DOCS_RESOURCES_GUILD/membership-screening-object)
   * enabled, this endpoint will default to adding new members as `pending` in the [guild member
   * object](#DOCS_RESOURCES_GUILD/guild-member-object). Members that are `pending` will have to
   ...
   * authorization), and the bot must be a member of the guild with `CREATE_INSTANT_INVITE` permission.
   */
  addGuildMember: {
    method: 'PUT',
    route: (guildId: string, userId: string) => `/guilds/${guildId}/members/${userId}`,
   ...
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object). Returns a
   * 200 OK with the [guild member](#DOCS_RESOURCES_GUILD/guild-member-object) as the body. Fires a
   * [Guild Member Update](#DOCS_TOPICS_GATEWAY/guild-member-update) Gateway event. If the
   * `channel_id` is set to null, this will force the target user to be disconnected from voice.
   *
   * All parameters to this endpoint are optional and nullable. When moving members to channels, the
   * API user _must_ have permissions to both connect to the channel and have the `MOVE_MEMBERS` permission.
   */
  modifyGuildMember: {
    method: 'PATCH',
    route: (guildId: string, userId: string) => `/guilds/${guildId}/members/${userId}`,
   ...
   *
   * Modifies the current member in a guild. Returns a 200 with the updated member object on
   * success. Fires a [Guild Member
   * Update](https://discordapp.com/developers/docs/topics/gateway#guild-member-update) Gateway event.
   */
  modifyCurrentMember: {
    method: 'PATCH',
  ...
  /**
   * @deprecated **Deprecated in favor of [Modify Current
   *   Member](https://discordapp.com/developers/docs/resources/guild#modify-current-member).**
   *
   ...
   *   success. Fires a [Guild Member Update](#DOCS_TOPICS_GATEWAY/guild-member-update) Gateway event.
   */
   ...
   *
   * Adds a role to a [guild
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object). Requires
   * the `MANAGE_ROLES` permission. Returns a 204 empty response on success. Fires a [Guild Member
   * Update](#DOCS_TOPICS_GATEWAY/guild-member-update) Gateway event.
   */
  addGuildMemberRole: {
    method: 'PUT',
    route: (guildId: string, userId: string, roleId: string) =>
   ...
   *
   * Remove a member from a guild. Requires `KICK_MEMBERS` permission. Returns a 204 empty response
   * on success. Fires a [Guild Member
   * Remove](https://discordapp.com/developers/docs/topics/gateway#guild-member-remove) Gateway event.
   */
  removeGuildMember: {
    method: 'DELETE',
    route: (guildId: string, userId: string) => `/guilds/${guildId}/members/${userId}`,
   ...
   *
   * Returns a list of [ban](https://discordapp.com/developers/docs/resources/guild#ban-object)
   ...
   *
   * Returns a [ban](https://discordapp.com/developers/docs/resources/guild#ban-object) object for
   * the given user or a 404 not found if the ban cannot be found. Requires the `BAN_MEMBERS` permission.
   */
  getGuildBan: {
    method: 'GET',
   ...
   * the `BAN_MEMBERS` permission. Returns a 204 empty response on success. Fires a [Guild Ban
   * Add](https://discordapp.com/developers/docs/topics/gateway#guild-ban-add) Gateway event.
   */
  createGuildBan: {
    method: 'PUT',
    route: (guildId: string, userId: string) => `/guilds/${guildId}/bans/${userId}`,
   ...
   *
   * Remove the ban for a user. Requires the `BAN_MEMBERS` permissions. Returns a 204 empty response
   * on success. Fires a [Guild Ban
   * Remove](https://discordapp.com/developers/docs/topics/gateway#guild-ban-remove) Gateway event.
   */
  removeGuildBan: {
    method: 'DELETE',
    route: (guildId: string, userId: string) => `/guilds/${guildId}/bans/${userId}`,
   ...
   *
   * Returns a list of [role](https://discordapp.com/developers/docs/topics/permissions#role-object)
   ...
   *
   * Create a new [role](https://discordapp.com/developers/docs/topics/permissions#role-object) for
   * the guild. Requires the `MANAGE_ROLES` permission. Returns the new
   * [role](#DOCS_TOPICS_PERMISSIONS/role-object) object on success. Fires a [Guild Role
   * Create](#DOCS_TOPICS_GATEWAY/guild-role-create) Gateway event. All JSON params are optional.
   */
  createGuildRole: {
    method: 'POST',
    route: (guildId: string) => `/guilds/${guildId}/roles`,
   ...
   *
   * Modify the positions of a set of
   * [role](https://discordapp.com/developers/docs/topics/permissions#role-object) objects for the
   * guild. Requires the `MANAGE_ROLES` permission. Returns a list of all of the guild's
   * [role](#DOCS_TOPICS_PERMISSIONS/role-object) objects on success. Fires multiple [Guild Role
   ...
   * [role](https://discordapp.com/developers/docs/topics/permissions#role-object) on success. Fires
   * a [Guild Role Update](#DOCS_TOPICS_GATEWAY/guild-role-update) Gateway event.
   *
   * All parameters to this endpoint are optional and nullable.
   */
  modifyGuildRole: {
   ...
   * [level](https://discordapp.com/developers/docs/resources/guild#guild-object-mfa-level) on
   * success. Fires a [Guild Update](#DOCS_TOPICS_GATEWAY/guild-update) Gateway event.
   */
  modifyGuildMFALevel: {
    method: 'POST',
   ...
   * success. Fires a [Guild Role
   * Delete](https://discordapp.com/developers/docs/topics/gateway#guild-role-delete) Gateway event.
   */
  deleteGuildRole: {
    method: 'DELETE',
    route: (guildId: string, roleId: string) => `/guilds/${guildId}/roles/${roleId}`,
   ...
   *
   * By default, prune will not remove users with roles. You can optionally include specific roles
   * in your prune by providing the `include_roles` parameter. Any inactive user that has a subset
   * of the provided role(s) will be counted in the prune and users with additional roles will not.
   */
  getGuildPruneCount: {
    method: 'GET',
   ...
   * large guilds it's recommended to set the `compute_prune_count` option to `false`, forcing
   * `pruned` to `null`. Fires multiple [Guild Member
   * Remove](https://discordapp.com/developers/docs/topics/gateway#guild-member-remove) Gateway events.
   *
   * By default, prune will not remove users with roles. You can optionally include specific roles
   * in your prune by providing the `include_roles` parameter. Any inactive user that has a subset
   * of the provided role(s) will be included in the prune and users with additional roles will not.
   */
  beginGuildPrune: {
    method: 'POST',
    route: (guildId: string) => `/guilds/${guildId}/prune`,
   ...
   * region](https://discordapp.com/developers/docs/resources/voice#voice-region-object) objects for
   * the guild. Unlike the similar `/voice` route, this returns VIP servers when the guild is VIP-enabled.
   */
   ...
   * Returns a list of
   * [invite](https://discordapp.com/developers/docs/resources/invite#invite-object) objects (with
   * [invite metadata](#DOCS_RESOURCES_INVITE/invite-metadata-object)) for the guild. Requires the
   ...
   *
   * Delete the attached
   * [integration](https://discordapp.com/developers/docs/resources/guild#integration-object) object
   * for the guild. Deletes any associated webhooks and kicks the associated bot if there is one.
   * Requires the `MANAGE_GUILD` permission. Returns a 204 empty response on success. Fires a [Guild
   * Integrations Update](#DOCS_TOPICS_GATEWAY/guild-integrations-update) Gateway event.
   */
  deleteGuildIntegration: {
    method: 'DELETE',
    route: (guildId: string, integrationId: string) =>
   ...
   *
   * Returns a [guild widget
   * settings](https://discordapp.com/developers/docs/resources/guild#guild-widget-settings-object)
   * object. Requires the `MANAGE_GUILD` permission.
   */
   ...
   * settings](https://discordapp.com/developers/docs/resources/guild#guild-widget-settings-object)
   * object for the guild. All attributes may be passed in with JSON and modified. Requires the
   * `MANAGE_GUILD` permission. Returns the updated [guild
   * widget](#DOCS_RESOURCES_GUILD/guild-widget-settings-object) object.
   */
  modifyGuildWidget: {
    method: 'PATCH',
    route: (guildId: string) => `/guilds/${guildId}/widget`,
   ...
   *
   * Returns the
   * [widget](https://discordapp.com/developers/docs/resources/guild#guild-widget-object) for the guild.
   */
  getGuildWidget: {
    method: 'GET',
   ...
   *
   * Returns a partial
   * [invite](https://discordapp.com/developers/docs/resources/invite#invite-object) object for
   * guilds with that feature enabled. Requires the `MANAGE_GUILD` permission. `code` will be null
   * if a vanity url for the guild is not set.
   */
  getGuildVanityURL: {
    method: 'GET',
   ...
   *
   * Returns the [Welcome
   * Screen](https://discordapp.com/developers/docs/resources/guild#welcome-screen-object) object
   * for the guild. If the welcome screen is not enabled, the `MANAGE_GUILD` permission is required.
   */
   ...
   * Screen](https://discordapp.com/developers/docs/resources/guild#welcome-screen-object). Requires
   * the `MANAGE_GUILD` permission. Returns the updated [Welcome
...
export const GuildScheduledEvent = group({
   ...
   *
   * Returns a list of [guild scheduled
   * event](https://discordapp.com/developers/docs/resources/guild-scheduled-event#guild-scheduled-event-object)
   * objects for the given guild.
   */
   ...
   *
   * Get a guild scheduled event. Returns a [guild scheduled
   * event](https://discordapp.com/developers/docs/resources/guild-scheduled-event#guild-scheduled-event-object)
   * object on success.
   */
  getGuildScheduledEvent: {
    method: 'GET',
    route: (guildId: string, guildScheduledEventId: string) =>
   ...
   * object on success.
   *
   * To start or end an event, use this endpoint to modify the event's
   * [status](#DOCS_RESOURCES_GUILD_SCHEDULED_EVENT/guild-scheduled-event-object-guild-scheduled-event-status)
   * field.
   *
   ...
   *
   * Get a list of guild scheduled event users subscribed to a guild scheduled event. Returns a list
   * of [guild scheduled event
   * user](https://discordapp.com/developers/docs/resources/guild-scheduled-event#guild-scheduled-event-user-object)
   * objects on success. Guild member data, if it exists, is included if the `with_member` query
   * parameter is set.
   */
...
export const GuildTemplate = group({
   ...
   *
   * Returns a [guild
   * template](https://discordapp.com/developers/docs/resources/guild-template#guild-template-object)
  ...
  syncGuildTemplate: {
    method: 'PUT',
    route: (guildId: string, templateCode: string) =>
   ...
   *
   * Deletes the template. Requires the `MANAGE_GUILD` permission. Returns the deleted [guild
   * template](https://discordapp.com/developers/docs/resources/guild-template#guild-template-object)
   * object on success.
   */
  deleteGuildTemplate: {
...
export const InteractionResponse = group({
   ...
   *
   * Create a response to an Interaction from the gateway. Body is an [interaction
   * response](https://discordapp.com/developers/docs/interactions/receiving-and-responding#interaction-response-object).
   * Returns `204 No Content`.
   *
   * This endpoint also supports file attachments similar to the webhook endpoints. Refer to
   * [Uploading Files](#DOCS_REFERENCE/uploading-files) for details on uploading files and
   * `multipart/form-data` requests.
   */
  createInteractionResponse: {
    method: 'POST',
    route: (interactionId: string, interactionToken: string) =>
   ...
   * Message](https://discordapp.com/developers/docs/resources/webhook#get-webhook-message).
   */
  getOriginalInteractionResponse: {
    method: 'GET',
    route: (applicationId: string, interactionToken: string) =>
   ...
   * Message](https://discordapp.com/developers/docs/resources/webhook#edit-webhook-message).
   */
   ...
   *
   * Deletes the initial Interaction response. Returns `204 No Content` on success. Does not support
   * ephemeral followups.
   */
   ...
   * Webhook](https://discordapp.com/developers/docs/resources/webhook#execute-webhook), but `wait`
   * is always true. The `thread_id`, `avatar_url`, and `username` parameters are not supported when
   * using this endpoint for interaction followups.
   *
   * `flags` can be set to `64` to mark the message as ephemeral, except when it is the first
   * followup message to a deferred Interactions Response. In that case, the `flags` field will be
   * ignored, and the ephemerality of the message will be determined by the `flags` value in your
   * original ACK.
   */
   ...
   *
   * Returns a followup message for an Interaction. Functions the same as [Get Webhook
   * Message](https://discordapp.com/developers/docs/resources/webhook#get-webhook-message).
   */
  getFollowupMessage: {
    method: 'GET',
    route: (applicationId: string, interactionToken: string, messageId: string) =>
   ...
   *
   * Deletes a followup message for an Interaction. Returns `204 No Content` on success. Does not
   * support ephemeral followups.
   */
...
export const Invite = group({
   ...
   *
   * Returns an [invite](https://discordapp.com/developers/docs/resources/invite#invite-object)
   * object for the given code.
   */
  getInvite: {
    method: 'GET',
   ...
   * to, or `MANAGE_GUILD` to remove any invite across the guild. Returns an
   * [invite](https://discordapp.com/developers/docs/resources/invite#invite-object) object on
   * success. Fires a [Invite Delete](#DOCS_TOPICS_GATEWAY/invite-delete) Gateway event.
   */
  deleteInvite: {
    method: 'DELETE',
    route: (inviteCode: string) => `/invites/${inviteCode}`,
...
export const Oauth2 = group({
   ...
   *
   * Returns the bot's
   * [application](https://discordapp.com/developers/docs/resources/application#application-object) object.
   */
...
export const StageInstance = group({
   ...
   *
   * Creates a new Stage instance associated to a Stage channel. Returns that [Stage
   * instance](https://discordapp.com/developers/docs/resources/stage-instance#stage-instance-object-stage-instance-structure).
   *
...
export const Sticker = group({
   ...
   *
   * Returns a [sticker](https://discordapp.com/developers/docs/resources/sticker#sticker-object)
   * object for the given sticker ID.
   */
  getSticker: {
    method: 'GET',
   ...
   *
   * Returns an array of
   * [sticker](https://discordapp.com/developers/docs/resources/sticker#sticker-object) objects for
   * the given guild. Includes `user` fields if the bot has the `MANAGE_EMOJIS_AND_STICKERS` permission.
   */
  listGuildStickers: {
    method: 'GET',
   ...
   *
   * Returns a [sticker](https://discordapp.com/developers/docs/resources/sticker#sticker-object)
   * object for the given guild and sticker IDs. Includes the `user` field if the bot has the
   ...
   * `MANAGE_EMOJIS_AND_STICKERS` permission. Returns the new
   * [sticker](https://discordapp.com/developers/docs/resources/sticker#sticker-object) object on success.
   *
   * Every guilds has five free sticker slots by default, and each Boost level will grant access to
   * more slots.
   *
   * Lottie stickers can only be uploaded on guilds that have either the `VERIFIED` and/or the
   * `PARTNERED` [guild feature](#DOCS_RESOURCES_GUILD/guild-object-guild-features).
   */
  createGuildSticker: {
    method: 'POST',
    route: (guildId: string) => `/guilds/${guildId}/stickers`,
   ...
   * updated [sticker](https://discordapp.com/developers/docs/resources/sticker#sticker-object)
   * object on success.
   *
   * All parameters to this endpoint are optional.
   */
...
export const User = group({
   ...
   *
   * Returns the [user](https://discordapp.com/developers/docs/resources/user#user-object) object of
   * the requester's account. For OAuth2, this requires the `identify` scope, which will return the
   * object _without_ an email, and optionally the `email` scope, which returns the object _with_ an email.
   */
  getCurrentUser: {
    method: 'GET',
    route: '/users/@me',
   ...
   *
   * Returns a [user](https://discordapp.com/developers/docs/resources/user#user-object) object for
   * a given user ID.
   */
  getUser: {
    method: 'GET',
   ...
   * [user](https://discordapp.com/developers/docs/resources/user#user-object) object on success.
   *
   * All parameters to this endpoint are optional.
   */
  modifyCurrentUser: {
   ...
   *
   * Returns a list of partial
   * [guild](https://discordapp.com/developers/docs/resources/guild#guild-object) objects the
   * current user is a member of. Requires the `guilds` OAuth2 scope.
   */
   ...
   * Returns a [guild
   * member](https://discordapp.com/developers/docs/resources/guild#guild-member-object) object for
   * the current user. Requires the `guilds.members.read` OAuth2 scope.
   */
   ...
   * channel](https://discordapp.com/developers/docs/resources/channel#channel-object) object.
   *
   * You should not use this endpoint to DM everyone in a server about something. DMs should
   * generally be initiated by a user action. If you open a significant amount of DMs too quickly,
   ...
   *   channel](https://discordapp.com/developers/docs/resources/channel#channel-object) object.
   *   This endpoint was intended to be used with the now-deprecated GameBridge SDK. DMs created
   *   with this endpoint will not be shown in the Discord client.
   *
   ...
   *
   * Returns a list of
   * [connection](https://discordapp.com/developers/docs/resources/user#connection-object) objects.
...
export const Voice = group({
   ...
   *
   * Returns an array of [voice
   * region](https://discordapp.com/developers/docs/resources/voice#voice-region-object) objects
   * that can be used when setting a voice or stage channel's
   * [`rtc_region`](#DOCS_RESOURCES_CHANNEL/channel-object-channel-structure).
   */
  listVoiceRegions: {
    method: 'GET',
    route: '/voice/regions',
...
export const Webhook = group({
   ...
   *
   * Creates a new webhook and returns a
   * [webhook](https://discordapp.com/developers/docs/resources/webhook#webhook-object) object on
   * success. Requires the `MANAGE_WEBHOOKS` permission.
   *
   * An error will be returned if a webhook name (`name`) is not valid. A webhook name is valid if:
   *
   * - It does not contain the substring '**clyde**' (case-insensitive)
   * - It follows the nickname guidelines in the [Usernames and
   *   Nicknames](#DOCS_RESOURCES_USER/usernames-and-nicknames) documentation, with an exception
   *   that webhook names can be up to 80 characters.
   */
  createWebhook: {
    method: 'POST',
   ...
   * [webhook](https://discordapp.com/developers/docs/resources/webhook#webhook-object) objects.
   ...
   *
   * Returns the new
   * [webhook](https://discordapp.com/developers/docs/resources/webhook#webhook-object) object for
   * the given id.
   */
  getWebhook: {
    method: 'GET',
   ...
   * [webhook](https://discordapp.com/developers/docs/resources/webhook#webhook-object) object on success.
   *
   * All parameters to this endpoint are optional.
   */
  modifyWebhook: {
   ...
   *
   * Delete a webhook permanently. Requires the `MANAGE_WEBHOOKS` permission. Returns a `204 No
   ...
   *
   * Refer to [Uploading Files](https://discordapp.com/developers/docs/reference/uploading-files/)
   * for details on attachments and `multipart/form-data` requests. Returns a message or `204 No
   * Content` depending on the `wait` query parameter.
   *
   * Note that when sending a message, you must provide a value for at **least one of** `content`,
   * `embeds`, or `file`.
   *
   * If the webhook channel is a forum channel, you must provide either `thread_id` in the query
   * string params, or `thread_name` in the JSON/form params. If `thread_id` is provided, the
   * message will send in that thread. If `thread_name` is provided, a thread with that name will be
   * created in the forum channel.
   */
  executeWebhook: {
    method: 'POST',
    route: (webhookId: string, webhookToken: string) => `/webhooks/${webhookId}/${webhookToken}`,
  ...
  executeSlackCompatibleWebhook: {
    method: 'POST',
    route: (webhookId: string, webhookToken: string) =>
   ...
   * select individual events" option and selecting individual events for the new webhook you're configuring.
   */
  ...
  getWebhookMessage: {
    method: 'GET',
    route: (webhookId: string, webhookToken: string, messageId: string) =>
