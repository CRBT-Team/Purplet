...
- Updated dependencies [[`20b20d5`](https://github.com/CRBT-Team/Purplet/commit/20b20d564234091974bc0af18f1fe4d92152271c)]:
...
- swap out `@discordjs/rest` with `@purplet/rest` ([#33](https://github.com/CRBT-Team/Purplet/pull/33))

* Extract `GatewayClient` to separate package `@purplet/gateway` ([#31](https://github.com/CRBT-Team/Purplet/pull/31))

* Updated dependencies [[`0ac1bdd`](https://github.com/CRBT-Team/Purplet/commit/0ac1bddf24f244207401d4e81b86e96fb649a3d1), [`1af5025`](https://github.com/CRBT-Team/Purplet/commit/1af5025c0e2db4689a7706ee8a669430e993f075)]:
...
- component custom ids allow longer feature ids, making it more unlikely to get an error thrown during usage ([#22](https://github.com/CRBT-Team/Purplet/pull/22))
